...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # Count success (class=1) and failed (class=0) for the selected site
        success_count = filtered_df[filtered_df['class'] == 1].shape[0]
        failed_count = filtered_df[filtered_df['class'] == 0].shape[0]
        
        # Create a new DataFrame for plotting the pie chart for the specific site
...
def get_scatter_graph(entered_site,payload_range):
